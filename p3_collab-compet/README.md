...
Files
================
- Tennis.ipynb: Jupyter Notebook to train the agent
- model.py: Actor and Critic class
- ddpg_agent.py: DDPG agent for learning
...
Futhermore, you need to download the environment from the link below. The ec2 instance doesn't support visualization of agent. So I used *Tennis_Linux_NoVis* agent.
